...
from .views import (
    ...
    RecepcionPedidoViewSet, PresupuestoMensualViewSet
)
...
router.register(r'recepciones', RecepcionPedidoViewSet, basename='recepcion')
router.register(r'presupuestos', PresupuestoMensualViewSet, basename='presupuesto')
